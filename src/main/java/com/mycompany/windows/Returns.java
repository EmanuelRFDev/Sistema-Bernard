...
import com.mycompany.bernard.DAOBooksImpl;
import com.mycompany.bernard.DAOLendingsImpl;
import com.mycompany.bernard.DAOUsersImpl;
...
public class Returns extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        folioTxt.setBackground(new java.awt.Color(51, 51, 51));
        folioTxt.setForeground(new java.awt.Color(255, 255, 255));
        folioTxt.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        folioTxt.setSelectedTextColor(new java.awt.Color(255, 255, 255));
        folioTxt.setSelectionColor(new java.awt.Color(255, 255, 0));

        libroIdLbl.setText("Libro ID");

        libroIdTxt.setBackground(new java.awt.Color(51, 51, 51));
        libroIdTxt.setForeground(new java.awt.Color(255, 255, 255));
        libroIdTxt.setSelectedTextColor(new java.awt.Color(255, 255, 255));
        libroIdTxt.setSelectionColor(new java.awt.Color(255, 255, 0));

        button.setBackground(new java.awt.Color(255, 153, 51));
        ...
        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biblio devoluciones.jpg"))); // NOI18N
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addComponent(image, javax.swing.GroupLayout.PREFERRED_SIZE, 484, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36))
        );
